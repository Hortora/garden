...
| ID | Title | Type | Score |
|----|----|-------|-------|
| GE-0173 | electron-builder `extraResources` strips the source directory name — packed path omits the subdir | gotcha | 11/15 |
| GE-0176 | Electron E2E tests silently fail in git worktrees — binary and runtime missing | gotcha | 11/15 |
...
| GE-20260525-6accc3 | Electron ready-to-show handler missed if registered after await loadURL — IPC messages silently lost | gotcha | 10/15 |
