...
tags: [applicationscoped, beans, cdi, dependency-injection, index, jandex, packaging, quarkus, silent-failure]
score: 14
verified: true
...
**See also:** GE-20260421-03fa72 — Quarkus optional module jar missing Jandex index — CDI beans not discovered by consuming modules | GE-20260423-a01832 — @Alternative beans in test jars not scanned without explicit index config


**See also:** [GE-20260424-59906a](GE-20260424-59906a.md) — first-party JAR CDI scanning; [GE-20260424-e9df70](GE-20260424-e9df70.md) — library JPA repository missing @ApplicationScoped
**See also:** [GE-20260427-987198](GE-20260427-987198.md) — quarkus.arc.exclude-types suppresses CDI beans from library JARs | [GE-20260427-c2b84f](GE-20260427-c2b84f.md) — @Alternative beans in test-helper jar invisible — producer-side Jandex fix

**See also:** GE-20260428-9311f8 — indexed casehub-engine SPI beans collide with consumer implementations