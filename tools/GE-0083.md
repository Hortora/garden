---
id: GE-0083
title: "BeautifulSoup `prettify()` silently discards trailing whitespace from inline element text nodes"
type: gotcha
domain: tools
stack: "Python BeautifulSoup4 (all versions, html.parser and lxml)"
tags: [beautifulsoup, inline, prettify, silent-failure, text, tools, whitespace]
score: 12
verified: true
