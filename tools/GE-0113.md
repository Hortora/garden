---
id: GE-0113
title: "`gh auth refresh` Requires an Interactive Terminal — the `!` Prefix in Claude Code Won't Complete the OAuth Flow"
type: gotcha
domain: tools
stack: "GitHub CLI (`gh`), Claude Code `!` prefix, any non-interactive shell"
tags: [auth, cdi, claude, flow, gh, prefix, terminal, tools]
score: 10
verified: true
