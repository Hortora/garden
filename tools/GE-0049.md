...
**See also:** GE-20260414-c08ba3 [gh issue close only accepts one issue number — bulk close requires a loop]
, GE-20260420-89f0c6 (gh issue create has no --json flag — parse issue number from stdout URL)
**See also:** [GE-20260428-dc4232 — gh issue create --label silently fails with 'could not add label' if label doesn't exist in repo](GE-20260428-dc4232.md)
