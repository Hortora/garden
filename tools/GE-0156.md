...
tags: [double, macos, pattern, sed, silent-failure, tools, when]
score: 13
verified: true
...
**See also:** [GE-20260516-c6d441](GE-20260516-c6d441.md) — BSD sed wipes file when replacement pattern has no match | [GE-20260512-0dc5df](GE-20260512-0dc5df.md) — macOS sed -i '' silently empties file when input is already empty

**See also:** [GE-20260531-050543](GE-20260531-050543.md) — macOS sed backreference substitution silently produces literal \1 when captured group contains quotes or parentheses
