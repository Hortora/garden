...
tags: [async, javascript, playwright, tools]
score: 8
verified: true
...
**See also:** [GE-20260427-f26db0 — Make window.__test helpers async and use page.evaluate('async () =>'...) to reliably await full UI pipeline in Playwright](GE-20260427-f26db0.md)
