...
| [observer-ledger-fallback.md](observer-ledger-fallback.md) | `@ObservesAsync @Transactional` observers with GCP ledger obligations require double try/catch + REQUIRES_NEW fallback writer | casehub-clinical — all `*Listener` beans writing GCP-required ledger entries |
