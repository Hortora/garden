...
- `~/.hortora/garden/approaches/security-audit.md` — OWASP Top 10 security principles (invoke for auth/payment/PII code)
- `~/.hortora/garden/approaches/testing.md` — Test strategy and coverage principles
