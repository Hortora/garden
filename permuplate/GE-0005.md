...
tags: [boundary, permuplate, silent-failure, types]
score: 12
verified: true
...
**See also:** [GE-20260427-cf8a08](GE-20260427-cf8a08.md) — @PermuteReturn(when=...) is silently ignored on methods with non-Object declared return types
